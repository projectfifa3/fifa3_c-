    ...
    public partial class frmAdmin : Form
    {
        ...
        private void btnLoadData_Click(object sender, EventArgs e)
        {
            if (!(txtPath.Text == null))
            {
                ...
                else if (tableSelect.Text == "matches")
                {
                ...
                else if (tableSelect.Text == "players")
                {
                    string data = sr.ReadLine();
                ...
                else if (tableSelect.Text == "teams")
                {
                    string data = sr.ReadLine();
        ...
        private void dgvAdminData_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
